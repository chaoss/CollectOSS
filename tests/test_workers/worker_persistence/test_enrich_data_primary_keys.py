...
def test_enrich_data_primary_keys_standard_input(database_connection, sample_source_data_enriched, sample_source_data_unenriched):
    ...
    dummyPersistent.enrich_data_primary_keys(sample_source_data_enriched, tableDict['contributors_table'], gh_merge_fields, merge_fields)
...
def test_enrich_data_primary_keys_bad_data(database_connection):
    ...
    assert dummyPersistent.enrich_data_primary_keys({}, "contributors_table", gh_merge_fields, merge_fields) == {}
    assert dummyPersistent.enrich_data_primary_keys(None, "contributors_table", gh_merge_fields, merge_fields) == None
...
def test_enrich_data_primary_keys_standard_input(database_connection, sample_source_data_bad_api_return, sample_source_data_unenriched):
    ...
    dummyPersistent.enrich_data_primary_keys(sample_source_data_bad_api_return, tableDict['contributors_table'], gh_merge_fields, merge_fields)
