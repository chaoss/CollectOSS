        ...
        Debugging this issue: 
            ...
            File "/home/ubuntu/github/virtualenvs/hosted/lib/python3.11/site-packages/celery/app/trace.py", line 734, in __protected_call__
                return self.run(*args, **kwargs)
                    ^^^^^^^^^^^^^^^^^^^^^^^^^
            File "/home/ubuntu/github/collectoss/collectoss/tasks/frontend.py", line 24, in add_org_repo_list
                with GithubTaskSession(logger) as session:
                    ^^^^^^^^^^^^^^^^^^^^^^^^^
            File "/home/ubuntu/github/collectoss/collectoss/tasks/github/util/github_task_session.py", line 44, in __init__
