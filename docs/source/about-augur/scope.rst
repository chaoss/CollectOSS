...
These usecases may work best as a complementary add-on project, new working group, or third-party addon to augur that depends on or extends CollectOSS functionality.
